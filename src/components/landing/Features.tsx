...
const features = [
  ...
  },
  {
    ...
    description: "Create customized calendars and timed journey maps tailored to you.",
    color: "secondary",
  },
  {
    icon: MessageSquare,
  ...
  },
  {
    ...
    description: "Streamline badge creation and check-in/out processes effortlessly.",
    color: "secondary",
  },
  {
    icon: BarChart3,
  ...
  },
  {
    ...
    description: "Access shared interest profiles, share on feed, message & set meetings.",
    color: "primary",
  },
  {
    icon: LayoutDashboard,
    title: "Organizer Dashboard",
    description: "Manage event details, registrations, heat-map views & data analytics.",
    color: "secondary",
  },
];
